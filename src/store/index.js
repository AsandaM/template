...
export default createStore({
  ...
  mutations: {
    ...
    setProfessionalCertificates(state, professinal_certificates) {
      state.professinal_certificates = professinal_certificates
    },
  ...
  actions: {
    async getData({ commit }) {
        ...
        let { work_experience, education, current_learnership, professinal_certificates, technical_skills, additional_experience, skills, references, aboutMe, testimonials } = data
        commit('setWorkExperience', work_experience)
        commit('setEducation', education)
        commit('setCurrentLearnership', current_learnership)
        commit('setProfessionalCertificates', professinal_certificates)
